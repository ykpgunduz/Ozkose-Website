                                ...
                                <div id="site-navigation" class="site-navigation">
                                    ...
                                    <nav id="menu" class="menu">
                                        <ul class="dropdown">
                                            ...
                                            <li class="active"><a href="{{ route('gida') }}">Hizmetlerimiz</a></li>
                    ...
                    <div class="col-lg-3 widget-area sidebar-left ttm-col-bgcolor-yes ttm-bg ttm-left-span ttm-bgcolor-grey">
                        ...
                        <aside class="widget widget-nav-menu">
                            <ul class="widget-menu">
                                ...
                                <li class="active"><a href="{{ route('gida') }}"> Gıda </a></li>
                    ...
                    <div class="col-lg-9 content-area">
                        ...
                        <div class="ttm-service-single-content-area">
                            <div class="ttm-service-description">
                                <h4>Gıda Hizmeti</h4>
                                <div class="mb-35">
                                    <p>Gıda hizmetimiz, dünya pazarlarına kaliteli ve güvenilir gıda ürünlerinin ihracatını kapsar. Bu hizmet, titiz planlama ve uluslararası gıda güvenliği standartlarına uyum gerektirir. Gıda üretim süreci, hammaddelerin temin edilmesinden başlayarak, işleme, paketleme ve dağıtım gibi çeşitli aşamaları içerir. Bu süreçte, hijyen ve kalite standartlarını koruyarak sağlıklı ve lezzetli ürünler sunmayı hedefliyoruz. Gıda hizmetlerimiz, modern teknolojiler ve sürdürülebilir yöntemlerle desteklenmektedir.</p>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="ttm_single_image-wrapper mb-35">
                                        <img style="border-radius: 10px;" class="img-fluid" src="{{ asset('images/hizmetler/gida-hizmeti-1.jpg') }}" alt="Proje Görseli">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="ttm_single_image-wrapper mb-35">
                                        <img style="border-radius: 10px;" class="img-fluid" src="{{ asset('images/hizmetler/gida-hizmeti-2.jpg') }}" alt="Proje Görseli">
                                    </div>
                                </div>
                            </div>
                            <!-- acadion -->
                            <div class="accordion mb-35">
                                ...
                                <div class="toggle ttm-style-classic ttm-toggle-title-bgcolor-grey active">
                                    <div class="toggle-title"><a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">Kaliteli Ürünler</a></div>
                                    <div class="toggle-content">
                                        <p>Ürettiğimiz ürünlerde en yüksek kalite standartlarını sağlamak için özenle çalışıyoruz. Taze ve doğal malzemeler kullanarak lezzetli ve besleyici ürünler sunuyoruz.</p>
                                    </div>
                                </div><!-- toggle end -->
                                <!-- toggle -->
                                <div class="toggle ttm-style-classic ttm-toggle-title-bgcolor-grey">
                                    <div class="toggle-title"><a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">Uzman Şefler</a></div>
                                    <div class="toggle-content">
                                        <p>Deneyimli şeflerimiz, her bir ürünün hazırlanmasında ustalıklarını konuşturuyor. Geleneksel tarifleri modern tekniklerle harmanlayarak benzersiz lezzetler yaratıyoruz.</p>
                                    </div>
                                </div><!-- toggle end -->
                                <!-- toggle -->
                                <div class="toggle ttm-style-classic ttm-toggle-title-bgcolor-grey">
                                    <div class="toggle-title"><a data-toggle="collapse" data-parent="#accordion" href="#collapseThree">Hijyen Standartları</a></div>
                                    <div class="toggle-content">
                                        <p>Hijyen konusunda titizlikle çalışarak, ürünlerimizin güvenli ve sağlıklı olmasını sağlıyoruz. Üretim ve paketleme süreçlerinde uluslararası standartlara uymaya özen gösteriyoruz.</p>
                                    </div>
                                </div><!-- toggle end -->
                                <!-- toggle -->
                                <div class="toggle ttm-style-classic ttm-toggle-title-bgcolor-grey">
                                    <div class="toggle-title"><a data-toggle="collapse" data-parent="#accordion" href="#collapseFour">Sürdürülebilir Üretim</a></div>
                                    <div class="toggle-content">
                                        <p>Çevreye duyarlı bir yaklaşımla üretim yapıyoruz. Sürdürülebilir tarım yöntemlerini destekliyor ve atıkları minimum seviyede tutmak için çaba sarf ediyoruz.</p>
                                    </div>
                                </div><!-- toggle end -->
                            </div><!-- acadion end-->                            
