                    ...
                    <div class="col-md-12"> 
                        <div class="title-box ttm-textcolor-white">
                            <div class="page-title-heading">
                                <h1 class="title">İltekno Ofis Binası Güçlendirme Çalışması</h1>
                                    ...
                                    <div class="ttm-featured-wrapper ttm-portfolio-featured-wrapper">
                                        <div class="portfolio-img-slide owl-carousel owl-theme owl-loaded mt_70" data-item="1" data-nav="false" data-dots="false" data-auto="true">
                                            <div class="post-image">
                                                <img style="width: 500px; height: 600px; object-fit: cover;" src="{{ asset('images/proje-iltekno/iltekno-01.jpg') }}" alt="Proje Görseli">
                                            </div>
                                            <div class="post-image">
                                                <img style="width: 500px; height: 600px; object-fit: cover;" src="{{ asset('images/proje-iltekno/iltekno-02.jpg') }}" alt="Proje Görseli">
                                            </div>
                                            <div class="post-image">
                                                <img style="width: 500px; height: 600px; object-fit: cover;" src="{{ asset('images/proje-iltekno/iltekno-03.jpg') }}" alt="Proje Görseli">
                                            </div>
                                            <div class="post-image">
                                                <img style="width: 500px; height: 600px; object-fit: cover;" src="{{ asset('images/proje-iltekno/iltekno-4.jpg') }}" alt="Proje Görseli">
                                            </div>
                                            <div class="post-image">
                                                <img style="width: 500px; height: 600px; object-fit: cover;" src="{{ asset('images/proje-iltekno/iltekno-5.jpg') }}" alt="Proje Görseli">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="ttm-pf-detailbox">
                                            <ul class="ttm-pf-detailbox-list">
                                                <li class="ttm-pf-details-date">
                                                    ...
                                                    <span class="ttm-pf-right-details">İltekno Ofis Binası Güçlendirme Çalışması</span>
                                                </li>
                                                <li class="ttm-pf-details-date">
                                                ...
                                                <li class="ttm-pf-details-date">
                                                    ...
                                                    <span class="ttm-pf-left-details">Firma </span>
                                                    <span class="ttm-pf-right-details">İltekno İleri Teknoloji Mühendislik ve Tic. A.Ş.</span>
                                                </li>
                                                <li class="ttm-pf-details-date">
                                                    <i class="fa fa-calendar"></i>
                                                    <span class="ttm-pf-left-details">Tarih </span>
                                                    <span class="ttm-pf-right-details">2013</span>
                                                </li>
                                                <li class="ttm-pf-details-date">
                                                    <i class="fa fa-clock-o"></i>
                                                    <span class="ttm-pf-left-details">Süre  </span>
                                                    <span class="ttm-pf-right-details">3 Ay</span>
                                                </li>
                                                <li class="ttm-pf-details-date">
                                                    <i class="fa fa-cube"></i>
                                                    <span class="ttm-pf-left-details">Yapı Alanı </span>
                                                    <span class="ttm-pf-right-details">1400 m2</span>
                                                </li>
                                                <li class="ttm-pf-details-date">
                                                    <i class="fa-brands fa-dropbox"></i>
                                                    <span class="ttm-pf-left-details">Yapı Taşıyıcı Sistemi </span>
                                                    <span class="ttm-pf-right-details">Betonarme Kark</span>
                                                </li>
                                                <li class="ttm-pf-details-date">
                                                    <i class="fa fa-map-marker"></i>
                                                    <span class="ttm-pf-left-details">Konum </span>
                                                    <span class="ttm-pf-right-details">Zincirlikuyu, Şişli/İstanbul</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                   ...
                   <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 widget-area">
                       <div class="widget widget_text clearfix">
                            <h3 class="widget-title">İletişim Bilgilerimiz</h3>
                                ...
                                <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-rounded ttm-btn-style-fill ttm-btn-color-black" href="mailto:iletisim@ozkosegroup.com">Buradan E-Posta Gönderebilirsiniz</a>
                            </div>
                       </div>
                   </div>
                   <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 widget-area">
