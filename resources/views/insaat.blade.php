...
<meta name="keywords" content="Özköse, Özköse Group, Özköse İnşaat, Ahmet Özköse, inşaat, turizm, madencilik, restorasyon, gıda, gayrimenkul, inşaat hizmetleri, yapı inşaatı">
<meta name="description" content="Özköse Group profesyonel inşaat hizmetleri. Kaliteli ve güvenilir inşaat çözümleri için uzman ekibimizle yanınızdayız." />
<meta name="viewport" content="width=device-width, initial-scale=1" />
<meta name="author" content="Özköse Group" />
<meta name="robots" content="index, follow" />

<!-- Open Graph Meta Tags -->
<meta property="og:title" content="İnşaat Hizmetleri - Özköse Group" />
<meta property="og:description" content="Özköse Group profesyonel inşaat hizmetleri. Kaliteli ve güvenilir inşaat çözümleri için uzman ekibimizle yanınızdayız." />
<meta property="og:type" content="website" />
<meta property="og:url" content="{{ url()->current() }}" />
<meta property="og:image" content="{{ asset('images/hizmetler/insaat-hizmeti-1.jpg') }}" />
<meta property="og:locale" content="tr_TR" />
<meta property="og:site_name" content="Özköse Group" />

<!-- Twitter Card Meta Tags -->
<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:title" content="İnşaat Hizmetleri - Özköse Group" />
<meta name="twitter:description" content="Özköse Group profesyonel inşaat hizmetleri. Kaliteli ve güvenilir inşaat çözümleri için uzman ekibimizle yanınızdayız." />
<meta name="twitter:image" content="{{ asset('images/hizmetler/insaat-hizmeti-1.jpg') }}" />

<title>İnşaat Hizmetleri - Özköse Group</title>
...
<script type="application/ld+json">
{
    ...
    "description": "Profesyonel inşaat hizmetleri ve çözümleri",
    "provider": {
        "@type": "Organization",
        "name": "Özköse Group",
        "url": "{{ route('anasayfa') }}"
    },
    "image": "{{ asset('images/hizmetler/insaat-hizmeti-1.jpg') }}"
}
</script>
</head>
                                ...
                                <div id="site-navigation" class="site-navigation">
                                    ...
                                    <nav id="menu" class="menu">
                                        <ul class="dropdown">
                                            ...
                                            <li class="active"><a href="{{ route('insaat') }}">Hizmetlerimiz</a></li>
                    ...
                    <div class="col-lg-3 widget-area sidebar-left ttm-col-bgcolor-yes ttm-bg ttm-left-span ttm-bgcolor-grey">
                        ...
                        <aside class="widget widget-nav-menu">
                            <ul class="widget-menu">
                                <li class="active"><a href="{{ route('insaat') }}"> İnşaat </a></li>
                    ...
                    <div class="col-lg-9 content-area">
                        ...
                        <div class="ttm-service-single-content-area">
                            <div class="ttm-service-description">
                                <h4>İnşaat Hizmeti</h4>
                                <div class="mb-35">
                                    <p>İnşaat hizmeti, yeni yapıların inşası ve mevcut yapıların modernizasyonu sürecini kapsar. Konut, ticari ve endüstriyel projelerde, titiz planlama ve mühendislik gerektirir. İnşaat süreci, projelendirme aşamasından başlayarak, temel atma, yapı inşası, iç ve dış mekan düzenlemeleri gibi çeşitli aşamaları içerir. Bu süreçte, yüksek kalite standartlarını koruyarak güvenli, dayanıklı ve estetik yapılar oluşturmayı hedefliyoruz. İnşaat hizmetlerimiz, modern teknolojiler ve sürdürülebilir çözümlerle desteklenmektedir.</p>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="ttm_single_image-wrapper mb-35">
                                        <img style="border-radius: 10px;" class="img-fluid" src="{{ asset('images/hizmetler/insaat-hizmeti-1.jpg') }}" alt="İnşaat Hizmeti 1">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="ttm_single_image-wrapper mb-35">
                                        <img style="border-radius: 10px;" class="img-fluid" src="{{ asset('images/hizmetler/insaat-hizmeti-2.jpg') }}" alt="İnşaat Hizmeti 2">
                                    </div>
                                </div>
                            </div>
                            <!-- acadion -->
                            <div class="accordion mb-35">
                                ...
                                <div class="toggle ttm-style-classic ttm-toggle-title-bgcolor-grey active">
                                    <div class="toggle-title"><a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">Kaliteli İnşaat Malzemeleri</a></div>
                                    <div class="toggle-content">
                                        <p>Projelerimizde en kaliteli inşaat malzemelerini kullanarak, uzun ömürlü ve güvenli yapılar oluşturuyoruz. Güvenilir tedarikçilerden malzeme temini yapıyor ve kalite kontrolü süreçlerini titizlikle yönetiyoruz.</p>
                                    </div>
                                </div><!-- toggle end -->
                                <!-- toggle -->
                                <div class="toggle ttm-style-classic ttm-toggle-title-bgcolor-grey">
                                    <div class="toggle-title"><a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">Uzman İnşaat Ekibi</a></div>
                                    <div class="toggle-content">
                                        <p>Deneyimli ve uzman bir ekip olarak, inşaat süreçlerini titizlikle yönetiyoruz. Her bir proje için özel olarak oluşturduğumuz ekiplerle, kaliteli işçilik ve güvenilir hizmet sunuyoruz.</p>
                                    </div>
                                </div><!-- toggle end -->
                                <!-- toggle -->
                                <div class="toggle ttm-style-classic ttm-toggle-title-bgcolor-grey">
                                    <div class="toggle-title"><a data-toggle="collapse" data-parent="#accordion" href="#collapseThree">Çevre Dostu Yaklaşım</a></div>
                                    <div class="toggle-content">
                                        <p>Çevreye duyarlı bir yaklaşımla projelerimizi gerçekleştiriyoruz. Sürdürülebilir inşaat yöntemlerini destekleyerek, doğal kaynakları korumaya ve atıkları en aza indirmeye özen gösteriyoruz.</p>
                                    </div>
                                </div><!-- toggle end -->
                                <!-- toggle -->
                                <div class="toggle ttm-style-classic ttm-toggle-title-bgcolor-grey">
                                    <div class="toggle-title"><a data-toggle="collapse" data-parent="#accordion" href="#collapseFour">İnovatif Çözümler</a></div>
                                    <div class="toggle-content">
                                        <p>Her proje için özgün ve yenilikçi çözümler üretiyoruz. Teknolojik gelişmeleri yakından takip ederek, projelerimizi daha verimli ve etkili bir şekilde gerçekleştiriyoruz.</p>
                                    </div>
                                </div><!-- toggle end -->
                            </div><!-- acadion end-->                            
