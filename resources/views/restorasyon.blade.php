...
<meta name="keywords" content="Özköse, Özköse Group, Özköse İnşaat, Ahmet Özköse, restorasyon, tarihi yapı restorasyonu, eski eser güçlendirmesi">
<meta name="description" content="Özköse Group profesyonel restorasyon hizmetleri. Tarihi yapıların restorasyonu ve eski eser güçlendirmesi için uzman ekibimizle hizmet veriyoruz." />
<meta name="viewport" content="width=device-width, initial-scale=1" />
<meta name="author" content="Özköse Group" />
<meta name="robots" content="index, follow" />
<title>Restorasyon Hizmetleri - Özköse Group</title>

<!-- Open Graph Meta Tags -->
<meta property="og:title" content="Restorasyon Hizmetleri - Özköse Group" />
<meta property="og:description" content="Özköse Group profesyonel restorasyon hizmetleri. Tarihi yapıların restorasyonu ve eski eser güçlendirmesi için uzman ekibimizle hizmet veriyoruz." />
<meta property="og:type" content="website" />
<meta property="og:url" content="{{ url()->current() }}" />
<meta property="og:image" content="{{ asset('images/hizmetler/restorasyon-hizmeti-1.jpg') }}" />
<meta property="og:locale" content="tr_TR" />
<meta property="og:site_name" content="Özköse Group" />

<!-- Twitter Card Meta Tags -->
<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:title" content="Restorasyon Hizmetleri - Özköse Group" />
<meta name="twitter:description" content="Özköse Group profesyonel restorasyon hizmetleri. Tarihi yapıların restorasyonu ve eski eser güçlendirmesi için uzman ekibimizle hizmet veriyoruz." />
<meta name="twitter:image" content="{{ asset('images/hizmetler/restorasyon-hizmeti-1.jpg') }}" />
...
<script type="application/ld+json">
{
  ...
  "@type": "Service",
  "name": "Restorasyon Hizmetleri",
  "description": "Özköse Group profesyonel restorasyon hizmetleri. Tarihi yapıların restorasyonu ve eski eser güçlendirmesi için uzman ekibimizle hizmet veriyoruz.",
  "provider": {
    "@type": "Organization",
    "name": "Özköse Group",
    "url": "{{ route('anasayfa') }}"
  },
  "serviceType": "Tarihi Yapı Restorasyonu",
  "areaServed": "Türkiye",
  "url": "{{ url()->current() }}",
  "offers": {
    "@type": "Offer",
                                ...
                                <div id="site-navigation" class="site-navigation">
                                    ...
                                    <nav id="menu" class="menu">
                                        <ul class="dropdown">
                                            ...
                                            <li class="active"><a href="{{ route('restorasyon') }}">Hizmetlerimiz</a></li>
                    ...
                    <div class="col-lg-3 widget-area sidebar-left ttm-col-bgcolor-yes ttm-bg ttm-left-span ttm-bgcolor-grey">
                        ...
                        <aside class="widget widget-nav-menu">
                            <ul class="widget-menu">
                                ...
                                <li class="active"><a href="{{ route('restorasyon') }}"> Restorasyon </a></li>
                    ...
                    <div class="col-lg-9 content-area">
                        ...
                        <div class="ttm-service-single-content-area">
                            <div class="ttm-service-description">
                                <h4>Restorasyon Hizmeti</h4>
                                <div class="mb-35">
                                    <p>Restorasyon hizmeti, mevcut bir yapının eski ihtişamına kavuşturulması sürecidir. Tarihi değeri olan binaların restorasyonu, dikkatli planlama ve uzmanlık gerektirir. Restorasyon süreci, binanın orijinal mimarisini korumayı ve onarmayı içerir. Bu süreçte dikkat edilmesi gereken en önemli nokta, binanın tarihi dokusunu koruyarak modern ihtiyaçlara uygun hale getirmektir. Restorasyon hizmetleri, tarihi binaların korunmasına ve kültürel mirasın gelecek nesillere aktarılmasına katkıda bulunur.</p>
                                    <p>Eski binaların ve yapıların restorasyonu konusunda uzmanız. Bizimle iletişime geçerek, restorasyon ihtiyaçlarınızı ve projelerinizi paylaşabilirsiniz. Size en iyi hizmeti sunmak için buradayız.</p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="ttm_single_image-wrapper mb-35">
                                        <img style="border-radius: 10px;" class="img-fluid" src="{{ asset('images/proje-nilufer-villa/before-2.JPG') }}" alt="Proje Görseli">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="ttm_single_image-wrapper mb-35">
                                        <img style="border-radius: 10px;" class="img-fluid" src="{{ asset('images/proje-nilufer-villa/after-1.JPG') }}" alt="Proje Görseli">
                                    </div>
                                </div>
                            </div>
                            <!-- acadion -->
                            <div class="accordion mb-35">
                                ...
                                <div class="toggle ttm-style-classic ttm-toggle-title-bgcolor-grey active">
                                    <div class="toggle-title"><a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">Tarihi Dokuyu Koruma</a></div>
                                    <div class="toggle-content">
                                        <p>Her restorasyon projesinde, binanın tarihi dokusunu korumaya özen gösteriyoruz. Orijinal mimari detaylarına saygı duyarak, yapıyı modern standartlara uygun hale getiriyoruz.</p>
                                    </div>
                                </div><!-- toggle end -->
                                <!-- toggle -->
                                <div class="toggle ttm-style-classic ttm-toggle-title-bgcolor-grey">
                                    <div class="toggle-title"><a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">Uzman Ekip</a></div>
                                    <div class="toggle-content">
                                        <p>Deneyimli ve uzman bir ekip olarak, restorasyon sürecini titizlikle yönetiyoruz. Restorasyonun her aşamasında kaliteli malzemeler ve işçilik kullanarak, uzun ömürlü sonuçlar elde ediyoruz.</p>
                                    </div>
                                </div><!-- toggle end -->
                                <!-- toggle -->
                                <div class="toggle ttm-style-classic ttm-toggle-title-bgcolor-grey">
                                    <div class="toggle-title"><a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">Belge ve Araştırma</a></div>
                                    <div class="toggle-content">
                                        <p>Restorasyon projelerimizde, eski belgeler, fotoğraflar ve diğer kaynaklardan yararlanıyoruz. Bu sayede, yapının geçmişine saygı göstererek, doğru ve özgün bir restorasyon gerçekleştiriyoruz.</p>
                                    </div>
                                </div><!-- toggle end -->
                                <!-- toggle -->
                                <div class="toggle ttm-style-classic ttm-toggle-title-bgcolor-grey">
                                    <div class="toggle-title"><a data-toggle="collapse" data-parent="#accordion" href="#collapseThree">Kültürel Mirası Koruma</a></div>
                                    <div class="toggle-content">
                                        <p>Restorasyon çalışmalarımız, tarihi ve kültürel mirasın korunmasına katkıda bulunmayı hedefler. Gelecek nesillere aktarılacak olan bu mirası korumak, bizim için büyük bir öneme sahiptir.</p>
                                    </div>
                                </div><!-- toggle end -->
                            </div><!-- acadion end-->
