...
<meta name="keywords" content="Özköse, Özköse Group, Özköse İnşaat, Ahmet Özköse, eski eser güçlendirmesi, Karaköy, restorasyon, güçlendirme">
<meta name="description" content="Karaköy'de Eski Eser Güçlendirmesi projesi. Özköse Group'un uzman ekibiyle gerçekleştirdiği tarihi yapı güçlendirme çalışması." />
<meta name="viewport" content="width=device-width, initial-scale=1" />
<meta name="author" content="Özköse Group" />
<meta name="robots" content="index, follow" />
<title>Karaköy Eski Eser Güçlendirmesi - Özköse Group</title>

<!-- Open Graph Meta Tags -->
<meta property="og:title" content="Karaköy Eski Eser Güçlendirmesi - Özköse Group" />
<meta property="og:description" content="Karaköy'de Eski Eser Güçlendirmesi projesi. Özköse Group'un uzman ekibiyle gerçekleştirdiği tarihi yapı güçlendirme çalışması." />
<meta property="og:type" content="website" />
<meta property="og:url" content="{{ url()->current() }}" />
<meta property="og:image" content="{{ asset('images/proje-eski-eser/karakoy-eski-eser-1.jpg') }}" />
<meta property="og:locale" content="tr_TR" />
<meta property="og:site_name" content="Özköse Group" />

<!-- Twitter Card Meta Tags -->
<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:title" content="Karaköy Eski Eser Güçlendirmesi - Özköse Group" />
<meta name="twitter:description" content="Karaköy'de Eski Eser Güçlendirmesi projesi. Özköse Group'un uzman ekibiyle gerçekleştirdiği tarihi yapı güçlendirme çalışması." />
<meta name="twitter:image" content="{{ asset('images/proje-eski-eser/karakoy-eski-eser-1.jpg') }}" />
...
<script type="application/ld+json">
{
  ...
  "@type": "CreativeWork",
  "name": "Karaköy Eski Eser Güçlendirmesi",
  "description": "Karaköy'de Eski Eser Güçlendirmesi projesi. Özköse Group'un uzman ekibiyle gerçekleştirdiği tarihi yapı güçlendirme çalışması.",
  "creator": {
    "@type": "Organization",
    "name": "Özköse Group"
  },
  ...
  "location": {
    "@type": "Place",
    "name": "Karaköy, Beyoğlu/İstanbul"
  },
  "category": "Güçlendirme ve Restorasyon",
  "image": "{{ asset('images/proje-eski-eser/karakoy-eski-eser-1.jpg') }}",
  "url": "{{ url()->current() }}",
  "duration": "P1Y"
}
</script>
...
<body class="ttm-one-page-site">
                    ...
                    <div class="col-md-12"> 
                        <div class="title-box ttm-textcolor-white">
                            <div class="page-title-heading">
                                <h1 class="title">Karaköy'de Eski Eser Güçlendirmesi</h1>
    ...
    <div class="site-main">
        ...
        <section class="ttm-row pt-60 clearfix">
            <div class="container">
                <!-- row -->
                <div class="row">
                    <div class="col-lg-12">
                                    ...
                                    <div class="ttm-featured-wrapper ttm-portfolio-featured-wrapper">
                                        <div class="portfolio-img-slide owl-carousel owl-theme owl-loaded mt_70" data-item="1" data-nav="false" data-dots="false" data-auto="true">
                                            <div class="post-image">
                                                <img style="width: 500px; height: 600px; object-fit: cover;" src="{{ asset('images/proje-eski-eser/karakoy-eski-eser-1.jpg') }}" alt="Proje Görseli">
                                            </div>
                                            <div class="post-image">
                                                <img style="width: 500px; height: 600px; object-fit: cover;" src="{{ asset('images/proje-eski-eser/karakoy-eski-eser-2.jpg') }}" alt="Proje Görseli">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="ttm-pf-detailbox">
                                            <ul class="ttm-pf-detailbox-list">
                                                <li class="ttm-pf-details-date">
                                                    ...
                                                    <span class="ttm-pf-right-details">Karaköy'de Eski Eser Güçlendirmesi</span>
                                                </li>
                                                <li class="ttm-pf-details-date">
                                                    <i class="fa fa-bookmark-o"></i>
                                                    <span class="ttm-pf-left-details">Kategori </span>
                                                    <span class="ttm-pf-right-details">Güçlendirme ve Restorasyon</span>
                                                </li>
                                                <li class="ttm-pf-details-date">
                                                    <i class="fa fa-calendar"></i>
                                                    <span class="ttm-pf-left-details">Tarih </span>
                                                    <span class="ttm-pf-right-details">2012</span>
                                                </li>
                                                <li class="ttm-pf-details-date">
                                                ...
                                                <li class="ttm-pf-details-date">
                                                    ...
                                                    <span class="ttm-pf-right-details">Karaköy, Beyoğlu/İstanbul</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
        ...
        <section class="ttm-row pb-0 res-991-pt-0 res-991-pb-0 clearfix">
            <div class="container">
