...
<title>Ahi Kent Villaları | Özköse Group</title>
                            ...
                            <div class="container">
                                ...
                                <div id="site-navigation" class="site-navigation">
                                        <div class="header-btn">
                                            <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-rounded ttm-btn-style-fill ttm-btn-color-black" href="{{ route('bize-ulasin') }}">Bize Ulaşın</a>
                                        </div>
                    ...
                    <div class="col-md-12"> 
                        <div class="title-box ttm-textcolor-white">
                            <div class="page-title-heading">
                                <h1 class="title">Ahi Kent Villaları</h1>
                                ...
                                <div class="col-md-6">
                                    <div class="ttm-featured-wrapper ttm-portfolio-featured-wrapper">
                                        <div class="post-image">
                                            <img class="img-fluid" src="{{ asset('images/ahikent-villalari.jpg') }}" alt="Proje Görseli">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                        ...
                                        <div class="ttm-pf-detailbox">
                                            <ul class="ttm-pf-detailbox-list">
                                                <li class="ttm-pf-details-date">
                                                    ...
                                                    <span class="ttm-pf-right-details">Ahi Kent Villaları</span>
                                                </li>
                                                <li class="ttm-pf-details-date">
                                                ...
                                                <li class="ttm-pf-details-date">
                                                    ...
                                                    <span class="ttm-pf-right-details">2010</span>
                                                </li>
                                                <li class="ttm-pf-details-date">
                                                    <i class="fa fa-clock-o"></i>
                                                    <span class="ttm-pf-left-details">Süre  </span>
                                                    <span class="ttm-pf-right-details">3-5 Yıl</span>
                                                </li>
                                                <li class="ttm-pf-details-date">
                                                    <i class="fa fa-map-marker"></i>
                                                    <span class="ttm-pf-left-details">Konum </span>
                                                    <span class="ttm-pf-right-details">Emniyettepe, Eyüpsultan/İstanbul</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <p>Ahi Kent Villaları, İstanbul'un tarihi ve doğal güzellikleriyle ünlü Eyüp ilçesinde konumlanmış, modern mimari anlayışla inşa edilmiş lüks bir konut projesidir. Bu proje, yüksek yaşam standartları sunarak sakinlerine hem şehir hayatının dinamiklerini hem de doğanın huzurunu bir arada yaşama imkânı sağlamaktadır. Proje, inşaat sektöründeki en güncel teknolojiler ve yüksek kaliteli malzemeler kullanılarak inşa edilmiştir. Yapım süreci boyunca çevre dostu uygulamalara önem verilmiş ve sürdürülebilirlik ilkeleri gözetilmiştir.</p>
                        <p>Projenin mimari tasarımı, modern estetik anlayışını yansıtan çizgilere sahiptir. Her villa, geniş ve ferah yaşam alanları sunacak şekilde planlanmıştır. İç mekânlarda kullanılan malzemeler, hem dayanıklılığı hem de şıklığı ile dikkat çekmektedir. Açık plan mutfaklar, geniş salonlar, ebeveyn banyolu yatak odaları ve büyük pencereler, villaların iç mekanlarının öne çıkan özelliklerindendir. Ahi Kent Villaları, sakinlerine sadece bir yaşam alanı sunmakla kalmaz, aynı zamanda sosyal bir yaşam merkezi de sunar. Site içerisinde yüzme havuzu, çocuk oyun alanları, spor salonu, sauna ve yürüyüş parkurları gibi birçok sosyal imkân bulunmaktadır. Güvenlik ise 24 saat aktif olarak çalışan güvenlik personeli ve kapalı devre kamera sistemi ile sağlanmaktadır.</p>
                        <p>Eyüp ilçesinin merkezi konumunda yer alan Ahi Kent Villaları, İstanbul'un her noktasına kolay ulaşım imkânı sunmaktadır. Şehrin önemli iş ve ticaret merkezlerine, alışveriş ve eğlence alanlarına, okullara ve sağlık kuruluşlarına yakın mesafede bulunan proje, aynı zamanda toplu taşıma araçlarına da rahatlıkla erişilebilecek bir konumdadır. Projenin en dikkat çeken özelliklerinden biri de çevre düzenlemesi ve peyzajıdır. Her villa, yeşil alanlarla çevrili olup, sakinlerine doğayla iç içe bir yaşam sunar. Özel bahçeler, yürüyüş yolları ve dinlenme alanları, villaların çevresini adeta bir cennet bahçesine dönüştürmektedir.</p>
                            ...
                            <div class="ttm-box-view-content-inner">
                                ...
                                <div class="ttm-box-view-overlay">
                                    <div class="featured-iconbox ttm-media-link">
                                        <a class="ttm_prettyphoto ttm_image" title="Ahi Kent Villaları | İstanbul, Türkiye" data-rel="prettyPhoto" href="{{ asset('images/proje-ahikent-villalari/ahikent-villalari.jpg') }}"><i class="ti ti-search"></i></a>
           ...
           <div class="container">
               <div class="row copyright">
                   <div class="col-md-8 ttm-footer2-left">
                       <a href="https://harpysocial.com" target="_blank"><img src="{{ asset('images/harpy-logo-removebg-preview.png') }}" class="harpy-social">Harpy Social © 2024</a>
                   </div>
                   <div class="col-md-4 ttm-footer2-right">
                      <div class="social-icons">
                           <ul class="list-inline">
                               <li><a href="#"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
                               <li><a href="https://www.linkedin.com/in/yakupgunduz" target="_blank"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
                           </ul>
                       </div>
                   </div>
               </div>
