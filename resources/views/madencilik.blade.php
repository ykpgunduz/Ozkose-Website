...
<title>Özköse Group | Madencilik</title>
                                ...
                                <div id="site-navigation" class="site-navigation">
                                    ...
                                    <nav id="menu" class="menu">
                                        <ul class="dropdown">
                                            ...
                                            <li class="active"><a href="{{ route('madencilik') }}">Hizmetlerimiz</a></li>
                    ...
                    <div class="col-lg-3 widget-area sidebar-left ttm-col-bgcolor-yes ttm-bg ttm-left-span ttm-bgcolor-grey">
                        ...
                        <aside class="widget widget-nav-menu">
                            <ul class="widget-menu">
                                ...
                                <li class="active"><a href="{{ route('madencilik') }}"> Madencilik </a></li>
                    ...
                    <div class="col-lg-9 content-area">
                        ...
                        <div class="ttm-service-single-content-area">
                            <div class="ttm-service-description">
                                <h4>Madencilik Hizmeti</h4>
                                <div class="mb-35">
                                    <p>Madencilik hizmeti, doğal kaynakların keşfi, çıkarılması ve işlenmesi süreçlerini kapsar. Bu hizmet, titiz planlama, uzman maden mühendisliği ve çevre yönetimi gerektirir. Madencilik süreci, saha çalışmaları ve sondajlarla başlayarak, maden çıkarma, işleme ve taşıma gibi aşamaları içerir. Bu süreçte, çevreye ve topluma duyarlı bir yaklaşımla çalışarak, sürdürülebilir madencilik uygulamalarıyla doğal kaynakları korumayı ve toplumun yaşam kalitesini artırmayı hedefliyoruz. Madencilik hizmetlerimiz, modern teknolojiler ve iş sağlığı güvenliği standartlarına uygun şekilde gerçekleştirilmektedir.</p>
                                    <p>Altın, kömür, demir gibi farklı maden türlerinde projelerde hizmet sunmaktayız. Madencilik ihtiyaçlarınızı ve projelerinizi bizimle paylaşarak, size en iyi hizmeti sunmak için buradayız.</p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="ttm_single_image-wrapper mb-35">
                                        <img style="border-radius: 10px;" class="img-fluid" src="{{ asset('images/hizmetler/madencilik-hizmeti-1.jpg') }}" alt="Proje Görseli">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="ttm_single_image-wrapper mb-35">
                                        <img style="border-radius: 10px;" class="img-fluid" src="{{ asset('images/hizmetler/madencilik-hizmeti-2.jpg') }}" alt="Proje Görseli">
                                    </div>
                                </div>
                            </div>
                            <!-- acadion -->
                            <div class="accordion mb-35">
                                ...
                                <div class="toggle ttm-style-classic ttm-toggle-title-bgcolor-grey active">
                                    <div class="toggle-title"><a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">Güvenli İşletme</a></div>
                                    <div class="toggle-content">
                                        <p>Madencilik faaliyetlerimizi, güvenli ve sürdürülebilir bir şekilde yürütüyoruz. Çalışanların ve çevrenin güvenliğini ön planda tutarak, modern teknolojileri kullanarak işletmelerimizi yönetiyoruz.</p>
                                    </div>
                                </div><!-- toggle end -->
                                <!-- toggle -->
                                <div class="toggle ttm-style-classic ttm-toggle-title-bgcolor-grey">
                                    <div class="toggle-title"><a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">Uzman Maden Mühendisleri</a></div>
                                    <div class="toggle-content">
                                        <p>Deneyimli maden mühendisleri ve uzman ekiplerle çalışarak, projelerimizi titizlikle yönetiyoruz. Madencilik sektöründeki en son gelişmeleri takip ederek, verimliliği artırmak için çaba sarf ediyoruz.</p>
                                    </div>
                                </div><!-- toggle end -->
                                <!-- toggle -->
                                <div class="toggle ttm-style-classic ttm-toggle-title-bgcolor-grey">
                                    <div class="toggle-title"><a data-toggle="collapse" data-parent="#accordion" href="#collapseThree">Çevre ve Toplum Dostu Yaklaşım</a></div>
                                    <div class="toggle-content">
                                        <p>Çevreye ve topluma duyarlı bir yaklaşımla madencilik faaliyetlerimizi yürütüyoruz. Doğal kaynakları korumaya özen gösteriyor ve toplumun yaşam kalitesini artırmak için projeler geliştiriyoruz.</p>
                                    </div>
                                </div><!-- toggle end -->
                                <!-- toggle -->
                                <div class="toggle ttm-style-classic ttm-toggle-title-bgcolor-grey">
                                    <div class="toggle-title"><a data-toggle="collapse" data-parent="#accordion" href="#collapseFour">Teknolojik İnovasyonlar</a></div>
                                    <div class="toggle-content">
                                        <p>Maden sektöründeki en son teknolojileri kullanarak, verimliliği ve güvenliği artırmak için çalışıyoruz. İnovatif yaklaşımlarımızla sektörde öncü olmayı hedefliyoruz.</p>
                                    </div>
                                </div><!-- toggle end -->
                            </div><!-- acadion end-->
