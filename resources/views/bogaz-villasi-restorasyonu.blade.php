                    ...
                    <div class="col-md-12"> 
                        <div class="title-box ttm-textcolor-white">
                            <div class="page-title-heading">
                                <h1 class="title">Boğaz Villası Restorasyonu</h1>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <p>Boğaz Villası Restorasyonu projemiz, Arnavutköy, İstanbul'da yer alan ve 1948 yılında Cumhuriyet dönemine ait olan ender yapılardan birinin restorasyonunu kapsamaktadır. II. sınıf koruma kurulu kararı ile başlatılan bu proje, tarihi yapının özgün mimari değerlerini koruyarak modern yaşam standartlarına uygun hale getirilmesini amaçlamaktadır. 2011 yılında başladığımız bu projeyi, 2012 yılında başarıyla tamamladık. Projeye başlarken, villanın tarihi ve mimari değerlerini göz önünde bulundurarak, titiz ve özenli bir restorasyon çalışması yürütmeyi hedefledik. Villanın mevcut durumunu tespit ederek, gerekli güçlendirme ve restorasyon çalışmalarını planladık. Bu süreçte, villanın orijinal dokusunu ve mimari özelliklerini korumaya büyük önem verdik.</p>
                        <p>Restorasyon sürecinde, villanın yapısal elemanları güçlendirilerek, modern tekniklerle uyumlu hale getirildi. Özellikle depreme dayanıklılığı artırmak için temel ve taşıyıcı sistemlerde kapsamlı çalışmalar yapıldı. Aynı zamanda, villanın estetik ve tarihi özelliklerini koruyarak, modern ve konforlu bir yaşam alanı oluşturmak amacıyla detaylı bir iç mekan tasarımı gerçekleştirildi. İç mekan tasarımında, tarihi dokuyu yansıtan ve modern konforu sağlayan bir yaklaşım benimsendi. Açık planlı ve geniş yaşam alanları oluşturularak, doğal ışık kullanımına özen gösterildi. Tarihi ve doğal malzemeler tercih edilerek, villanın özgün atmosferi korunurken, modern yaşam standartlarına uygun hale getirildi.</p>
                        <p>Boğaz Villası Restorasyonu projesi, tarihi bir yapının, özgünlüğünü koruyarak modern ve kullanışlı bir yaşam alanına dönüştürülmesi sürecinde büyük bir başarı örneği olmuştur. Projemiz, hem estetik hem de işlevsellik açısından mükemmel bir sonuç ortaya koyarak, tarihi yapının geleceğe taşınmasına katkı sağlamaktadır.</p>
