                    ...
                    <div class="col-md-12"> 
                        <div class="title-box ttm-textcolor-white">
                            <div class="page-title-heading">
                                <h1 class="title">Mermerci Holding Villa Projemiz</h1>
                                ...
                                <div class="ttm-featured-wrapper ttm-portfolio-featured-wrapper">
                                    <div class="portfolio-img-slide owl-carousel owl-theme owl-loaded mt_70" data-item="1" data-nav="false" data-dots="false" data-auto="true">
                                        <div class="post-image">
                                            <img style="width: 500px; height: 500px; object-fit: cover;" src="{{ asset('images/proje-mermerci/foto1.jpg') }}" alt="Proje Görseli">
                                        </div>
                                        <div class="post-image">
                                            <img style="width: 500px; height: 500px; object-fit: cover;" src="{{ asset('images/proje-mermerci/foto2.jpg') }}" alt="Proje Görseli">
                                        </div>
                                        <div class="post-image">
                                            <img style="width: 500px; height: 500px; object-fit: cover;" src="{{ asset('images/proje-mermerci/foto3.jpg') }}" alt="Proje Görseli">
                                        </div>
                                        <div class="post-image">
                                            <img style="width: 500px; height: 500px; object-fit: cover;" src="{{ asset('images/proje-mermerci/foto4.jpg') }}" alt="Proje Görseli">
                                        </div>
                                        <div class="post-image">
                                            <img style="width: 500px; height: 500px; object-fit: cover;" src="{{ asset('images/proje-mermerci/foto5.jpg') }}" alt="Proje Görseli">
                                        </div>
                                        <div class="post-image">
                                            <img style="width: 500px; height: 500px; object-fit: cover;" src="{{ asset('images/proje-mermerci/foto6.jpg') }}" alt="Proje Görseli">
                                        </div>
                                        <div class="post-image">
                                            <img style="width: 500px; height: 500px; object-fit: cover;" src="{{ asset('images/proje-mermerci/foto7.jpg') }}" alt="Proje Görseli">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="ttm-pf-detailbox">
                                        <ul class="ttm-pf-detailbox-list">
                                            <li class="ttm-pf-details-date">
                                                ...
                                                <span class="ttm-pf-right-details">Mermerci Holding Villa Projesi</span>
                                            </li>
                                            <li class="ttm-pf-details-date">
                                                <i class="fa fa-user"></i>
                                                <span class="ttm-pf-left-details">Müşteri </span>
                                                <span class="ttm-pf-right-details">Petek Mermerci | Mermerci Holding</span>
                                            </li>
                                            <li class="ttm-pf-details-date">
                                            ...
                                            <li class="ttm-pf-details-date">
                                                ...
                                                <span class="ttm-pf-right-details">Emirgan, Sarıyer/İstanbul</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <p>Mermerci Holding Müstakil Villa İnşaatı projemiz, Emirgan, Sarıyer/İstanbul'da yer alan prestijli bir lokasyonda, müstakil bir villanın inşaatını kapsamaktadır. 2021 yılında başladığımız bu projeyi, bir yıl süren titiz bir çalışmanın ardından 2022 yılında başarıyla tamamladık. Projeye başlarken, Mermerci Holding'in beklentilerini ve yaşam tarzını göz önünde bulundurarak, modern ve konforlu bir yaşam alanı oluşturmayı hedefledik. Projenin konumu, Boğaz manzarası ve seçkin çevresi ile öne çıkmaktadır. Bu özellikleri koruyarak, yapı ve çevresi arasında uyum sağlamaya özen gösterdik.</p>
                        ...
                        <p>Dış mekanda ise, doğal çevre ile uyumlu peyzaj çalışmaları gerçekleştirildi. Geniş bir bahçe alanı ve doğa ile iç içe yaşam alanları ile villa, sakinlerine hem konforlu hem de estetik açıdan tatmin edici bir yaşam sunmaktadır. Mermerci Holding Müstakil Villa İnşaatı projesi, prestijli bir bölgede, modern ve konforlu bir yaşam alanı yaratma amacıyla gerçekleştirilmiş ve büyük bir başarı ile tamamlanmıştır. Projemiz, müşterimizin beklentilerini fazlasıyla karşılayarak, hem estetik hem de işlevsellik açısından örnek bir yapı olarak öne çıkmaktadır.</p>
