...
<meta name="keywords" content="Özköse, Özköse Group, Özköse İnşaat, Ahmet Özköse, turizm, turizm hizmetleri, otel inşaatı, turizm tesisleri">
<meta name="description" content="Özköse Group profesyonel turizm hizmetleri. Otel inşaatları, turizm tesisleri ve tatil köyleri için uzman çözümler sunuyoruz." />
<meta name="viewport" content="width=device-width, initial-scale=1" />
<meta name="author" content="Özköse Group" />
<meta name="robots" content="index, follow" />
<title>Turizm Hizmetleri - Özköse Group</title>

<!-- Open Graph Meta Tags -->
<meta property="og:title" content="Turizm Hizmetleri - Özköse Group" />
<meta property="og:description" content="Özköse Group profesyonel turizm hizmetleri. Otel inşaatları, turizm tesisleri ve tatil köyleri için uzman çözümler sunuyoruz." />
<meta property="og:type" content="website" />
<meta property="og:url" content="{{ url()->current() }}" />
<meta property="og:image" content="{{ asset('images/hizmetler/turizm-hizmeti-1.jpg') }}" />
<meta property="og:locale" content="tr_TR" />
<meta property="og:site_name" content="Özköse Group" />

<!-- Twitter Card Meta Tags -->
<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:title" content="Turizm Hizmetleri - Özköse Group" />
<meta name="twitter:description" content="Özköse Group profesyonel turizm hizmetleri. Otel inşaatları, turizm tesisleri ve tatil köyleri için uzman çözümler sunuyoruz." />
<meta name="twitter:image" content="{{ asset('images/hizmetler/turizm-hizmeti-1.jpg') }}" />
...
<script type="application/ld+json">
{
  ...
  "@type": "Service",
  "name": "Turizm Hizmetleri",
  "description": "Özköse Group profesyonel turizm hizmetleri. Otel inşaatları, turizm tesisleri ve tatil köyleri için uzman çözümler sunuyoruz.",
  "provider": {
    "@type": "Organization",
    "name": "Özköse Group",
    "url": "{{ route('anasayfa') }}"
  },
  "serviceType": "Turizm İnşaatı ve Hizmetleri",
  "areaServed": "Türkiye",
  "url": "{{ url()->current() }}",
  "offers": {
    "@type": "Offer",
                                ...
                                <div id="site-navigation" class="site-navigation">
                                    ...
                                    <nav id="menu" class="menu">
                                        <ul class="dropdown">
                                            ...
                                            <li class="active"><a href="{{ route('turizm') }}">Turizm</a></li>
                    ...
                    <div class="col-lg-9 content-area">
                        ...
                        <div class="ttm-service-single-content-area">
                            <div class="ttm-service-description">
                                <h4>Turizm Hizmeti</h4>
                                <div class="mb-35">
                                    <p>Turizm hizmeti, seyahat ve konaklama imkanları sağlayarak turistlerin ihtiyaçlarını karşılamayı amaçlar. Bu hizmet, destinasyonların tanıtımı, seyahat planlaması ve konaklama düzenlemelerini içerir. Turizm süreci, turistik alanların geliştirilmesi, tur rehberliği, etkinlik düzenleme gibi çeşitli aşamaları içerir. Bu süreçte, turistlerin memnuniyetini ve konforunu ön planda tutarak, unutulmaz ve keyifli seyahat deneyimleri sunmayı hedefliyoruz. Turizm hizmetlerimiz, turistik destinasyonların potansiyelini artırmak ve yerel ekonomilere katkıda bulunmak amacıyla sürdürülebilir turizm ilkelerine uygun şekilde gerçekleştirilmektedir.</p>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="ttm_single_image-wrapper mb-5">
                                        <img style="border-radius: 10px;" class="img-fluid" src="{{ asset('images/hizmetler/turizm-hizmeti-1.jpg') }}" alt="Proje Görseli">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="ttm_single_image-wrapper mb-5">
                                        <img style="border-radius: 10px;" class="img-fluid" src="{{ asset('images/hizmetler/turizm-hizmeti-2.jpg') }}" alt="Proje Görseli">
                                    </div>
                                </div>
                            </div>
                            <!-- acadion -->
                            <div class="accordion mb-35">
                                ...
                                <div class="toggle ttm-style-classic ttm-toggle-title-bgcolor-grey active">
                                    <div class="toggle-title"><a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">Çeşitli Destinasyonlar</a></div>
                                    <div class="toggle-content">
                                        <p>Müşterilerimize çeşitli destinasyonlar sunarak, onların seyahat deneyimlerini zenginleştirmeyi amaçlıyoruz. Doğa, kültür, tarih ve macera turizmi gibi farklı türlerde tatil imkanları sağlıyoruz.</p>
                                    </div>
                                </div><!-- toggle end -->
                                <!-- toggle -->
                                <div class="toggle ttm-style-classic ttm-toggle-title-bgcolor-grey">
                                    <div class="toggle-title"><a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">Profesyonel Rehberler</a></div>
                                    <div class="toggle-content">
                                        <p>Deneyimli ve bilgili rehberlerimiz, müşterilerimize her destinasyonda en iyi rehberlik hizmetini sunmayı hedefliyor. Yerel kültürü ve doğayı tanıtmak için özenle çalışıyoruz.</p>
                                    </div>
                                </div><!-- toggle end -->
                                <!-- toggle -->
                                <div class="toggle ttm-style-classic ttm-toggle-title-bgcolor-grey">
                                    <div class="toggle-title"><a data-toggle="collapse" data-parent="#accordion" href="#collapseThree">Kaliteli Konaklama</a></div>
                                    <div class="toggle-content">
                                        <p>Müşterilerimizin konforunu ve memnuniyetini ön planda tutarak, kaliteli konaklama imkanları sunuyoruz. Her bütçeye uygun otel ve konaklama seçenekleri ile geniş bir yelpaze sunmaktayız.</p>
                                    </div>
                                </div><!-- toggle end -->
                                <!-- toggle -->
                                <div class="toggle ttm-style-classic ttm-toggle-title-bgcolor-grey">
                                    <div class="toggle-title"><a data-toggle="collapse" data-parent="#accordion" href="#collapseFour">Etkinlik ve Geziler</a></div>
                                    <div class="toggle-content">
                                        <p>Müşterilerimize unutulmaz deneyimler yaşatmak için çeşitli etkinlikler ve geziler düzenliyoruz. Doğa yürüyüşleri, tarihi yerler gezileri ve kültürel etkinlikler gibi seçenekler sunuyoruz.</p>
                                    </div>
                                </div><!-- toggle end -->
                            </div><!-- acadion end-->                                                    
